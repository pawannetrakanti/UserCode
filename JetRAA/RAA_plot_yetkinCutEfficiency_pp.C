...
void RAA_plot_yetkinCutEfficiency_pp(Int_t radius = 3){
  ...
  TFile *fout = new TFile(Form("Output/Pp_CutEfficiency_YetkinCuts_matched_slantedlinecalopfpt_addingunmatched_exclusionhighertriggers_eMaxSumcand_A_R0p%d.root",radius),"RECREATE");
  fout->cd();
