  ...
  for(unsigned i=0;i<fNames.size();i++)
    {
	  ...
	  if (!mIsJetEtaset)std::cout<<"JetCorrectionUncertainty::"<<" jet eta is not set"<<std::endl;
	  ...
	  if (!mIsJetPtset)std::cout<<"JetCorrectionUncertainty::"<<" jet pt is not set"<<std::endl;  
      ...
      else if (fNames[i] == "JetPhi")
        {
          ...
          if (!mIsJetPhiset)std::cout<<"JetCorrectionUncertainty::"<<" jet phi is not set"<<std::endl;  
          else result.push_back(mJetPt);
        }
      else if (fNames[i] == "JetE")
        {
          //if (!mIsJetEset)throw cms::Exception("JetCorrectionUncertainty::")<<" jet energy is not set";
          if (!mIsJetEset)std::cout<<"JetCorrectionUncertainty::"<<" jet energy is not set"<<std::endl;
      ...
      else if (fNames[i] == "JetEMF")
        {
          ...
          if (!mIsJetEMFset)std::cout<<"JetCorrectionUncertainty::"<<" jet emf is not set"<<std::endl;
	  ...
	  if (!mIsLepPxset)std::cout<<"JetCorrectionUncertainty::"<<" lepton px is not set"<<std::endl;  
      ...
      else if (fNames[i] == "LepPy")
        {
          ...
          if (!mIsLepPyset)std::cout<<"JetCorrectionUncertainty::"<<" lepton py is not set"<<std::endl;  
      ...
      else if (fNames[i] == "LepPz")
        {
          ...
          if (!mIsLepPzset)std::cout<<"JetCorrectionUncertainty::"<<" lepton pz is not set"<<std::endl;  
...
float JetCorrectionUncertainty::getPtRel()
{
  ...
  if (!(lj2 > 0))std::cout<<"JetCorrectionUncertainty"<<" not positive lepton-jet momentum: "<<lj2<<std::endl;
