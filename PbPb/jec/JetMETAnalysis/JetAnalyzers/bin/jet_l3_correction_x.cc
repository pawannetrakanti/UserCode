...
int main(int argc,char**argv)
{
  ...
  while ((dirKey=(TKey*)nextDir())) {
    ...
    if (alg.find("PF")!=string::npos) {
      ...
      fitrsp->SetParameter(2,-0.65);
      fitrsp->SetParameter(3,0.038);
      fitrsp->SetParameter(4,1.06);
      fitrsp->SetParameter(5,2.5);
      fitrsp->SetParameter(6,0.016);

      //!  Pawan   
//       if(alg.find("Vs")!=string::npos){
//    	fitrsp->SetParameter(0,0.98);
...
//    	fitrsp->SetParameter(1,0.04);
//    	fitrsp->SetParameter(2,-0.7);
//    	fitrsp->SetParameter(3,0.02);
//    	fitrsp->SetParameter(4,1.02);
//    	fitrsp->SetParameter(5,2.5);
//    	fitrsp->SetParameter(6,0.011);
//    	fitrsp->SetParLimits(6,0.01,0.02);
//      }
    }
...
//       fitcor->SetParLimits(6,0.01,0.025);
      ...
      //! Pawan
//       if(alg.find("Vs")!=string::npos){
//  	fitcor->SetParameter(0,1.00);
//  	fitcor->SetParameter(1,0.033);
//  	fitcor->SetParameter(2,-0.7);
//  	fitcor->SetParameter(3,0.02);
//  	fitcor->SetParameter(4,1.02);
//  	fitcor->SetParameter(5,2.7);
//  	fitcor->SetParameter(6,0.011);
//       }else{
...
//  	fitcor->SetParLimits(6,0.01,0.02);
//       }
    }
    else if (alg.find("trk")!=string::npos) {
