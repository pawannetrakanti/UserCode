...
#jet_response_analyzer_x  jra_fine_binning_lowpt.config -input dijet_pp_official_mergedpthatbins_Track8_Jet28_MC.root -useweight true \
#  -output jra_hiF_ak_dijet_official_fine_lowpt.root \

#jet_response_analyzer_x  jra_lowpt.config -input dijet_pp_official_mergedpthatbins_Track8_Jet28_MC.root -useweight true \
#  -output jra_hiF_ak_dijet_official_lowpt.root \
#  -algs \
...
#jet_l3_correction_x -input jra_hiF_ak_dijet_official_fine_lowpt.root -era JEC_pp_PYTHIAZ2_2760GeV_5316_v28 -batch true -formats pdf \
#    -output jra_hiF_ak_l3_dijet_official_fine_lowpt.root \
#jet_l3_correction_x -input jra_hiF_ak_dijet_official_lowpt.root -era JEC_pp_PYTHIAZ2_2760GeV_5316_v28 -batch true -formats pdf \
#    -output jra_hiF_ak_l3_dijet_official_lowpt.root \
#    -algs \
...
jet_l2_correction_x -input jra_hiF_ak_dijet_official_lowpt.root -l3input jra_hiF_ak_l3_dijet_official_lowpt.root -era JEC_pp_PYTHIAZ2_2760GeV_5316_v28 -batch true -formats pdf \
    -output jra_hiF_ak_l2_dijet_official_lowpt.root \
    -algs \
    ak1PFJetAnalyzer ak2PFJetAnalyzer ak3PFJetAnalyzer ak4PFJetAnalyzer ak5PFJetAnalyzer ak6PFJetAnalyzer ak7PFJetAnalyzer \
    ak1CaloJetAnalyzer ak2CaloJetAnalyzer ak3CaloJetAnalyzer ak4CaloJetAnalyzer ak5CaloJetAnalyzer  ak6CaloJetAnalyzer ak7CaloJetAnalyzer 
