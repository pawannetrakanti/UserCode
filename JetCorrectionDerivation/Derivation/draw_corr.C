...
int draw_corr(const char *ctype="PF")
{
  ...
  TFile *fin_l3    = new TFile("jra_hiF_akpf_l3_dijet.root","r");
  TFile *fin_l2 = new TFile("jra_hiF_akpf_l2_dijet.root","r");
  ...
  drawText2("CMSSW_5_3_20" ,0.17,0.40,21);    
  //drawText2("STARTHI53_LV1",0.17,0.30,21);    
  //drawText2("Track8_Jet29" ,0.17,0.20,21);    
  if(iSave){
    c11->SaveAs(Form("FinalPlots/ppOfficial/L3Response_%s.gif",ctype));
    c11->SaveAs(Form("FinalPlots/ppOfficial/L3Response_%s.pdf",ctype));
  }
  ...
  //drawText2("Track8_Jet29" ,0.17,0.20,21);    
  if(iSave){
    c12->SaveAs(Form("FinalPlots/ppOfficial/L3Correction_%s.gif",ctype));
    c12->SaveAs(Form("FinalPlots/ppOfficial/L3Correction_%s.pdf",ctype));
  }
  ...
  for(int nj=0; nj<knj; nj++){
    ...
    c99[nj]->cd(24);
    drawText2("CMSSW_5_3_20" ,0.17,0.70,21);    
    //drawText2("STARTHI53_LV1",0.17,0.50,21);    
    //drawText2("Track8_Jet29" ,0.17,0.30,21);    

    if(iSave){
      c99[nj]->SaveAs(Form("FinalPlots/ppOfficial/L2AbsCorr_%s%s.gif",calgo[nj],ctype));
      c99[nj]->SaveAs(Form("FinalPlots/ppOfficial/L2AbsCorr_%s%s.pdf",calgo[nj],ctype));
    }
  ...
  for(int nj=0; nj<knj; nj++){
    ...
    for(int ie=0;ie<neta;ie++){      
      ...
      grelcor_l2[nj][ie]->GetXaxis()->SetRangeUser(30,1000);      
    ...
    if(iSave){
      c98[nj]->SaveAs(Form("FinalPlots/ppOfficial/L2RelativeCorr_%s%s.gif",calgo[nj],ctype));
      c98[nj]->SaveAs(Form("FinalPlots/ppOfficial/L2RelativeCorr_%s%s.pdf",calgo[nj],ctype));
    }
  }
