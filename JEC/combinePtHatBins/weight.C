	   ...
	   )
{
  ...
  float effec_xsec = GetXsec(maxpthat);


  TFile *fout=new TFile(outfile,"RECREATE");

  TTree *tr_in=0, *tr_out;
  Int_t           hiBin;  
  ...
  for(Int_t idir=0;idir<ndir;idir++){
    ...
    if(updateCorrections){
      L2Name = "/net/hisrv0001/home/pawan/Validation/Track8_Jet19/CMSSW_5_3_16/src/JEC_base/pbpb2014/final/JEC_2011RECO_STARTHI53_LV1_5_3_16_Track8_Jet29_L2Relative_"+corrFileName[idir]+".txt";
      cout<<"**** ++++++  L2Name "<<L2Name<<endl;
      L3Name = "/net/hisrv0001/home/pawan/Validation/Track8_Jet19/CMSSW_5_3_16/src/JEC_base/pbpb2014/final/JEC_2011RECO_STARTHI53_LV1_5_3_16_Track8_Jet29_L3Absolute_"+corrFileName[idir]+".txt";
    ...
    float fentries = el->GetN();

    weight = effec_xsec/(fentries/1000.);
    cout<<" weight "<<weight<<" \t " << tr_in->GetName() << " total entries : " << tr_in->GetEntries() << "Effective entries : " << fentries << endl;
